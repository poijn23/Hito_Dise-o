...
Si lo hay, es necesario abstraer el concepto de oponente y presupuestar tiempo de cómputo dentro del segundo de CON-07. Si no lo hay, toda partida requiere dos jugadores humanos conectados. \\ \hline
...
Q-03 & ¿Con qué mecanismo se implementa el segundo factor exigido por CON-08? & STK-05, STK-15 &
...
Si se cifra, se añade coste por mensaje al presupuesto de CON-07 y se complica el protocolo propio. Si no, las credenciales y los secretos viajan expuestos, lo que contradice el propósito de CON-08. \\ \hline
