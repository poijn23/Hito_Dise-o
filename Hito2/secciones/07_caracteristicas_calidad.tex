...
En el H1 se levantó una primera lista de características de calidad (QA-01 a QA-09). En esta sección se afina esa lista: cada característica se lleva a la subcaracterística de ISO/IEC~25010 que realmente importa para este juego, se justifica con los stakeholders y concerns que la exigen, se prioriza y se enlaza con los escenarios de la sección~8 que la vuelven verificable. Se conservan los identificadores del H1 para no romper la trazabilidad.
...
\begin{itemize}
  \item S1. Al menos un stakeholder la exige con un concern propio, dicho con sus palabras en el H1. No basta con que sea deseable en general.
...
Las características seleccionadas no se pueden maximizar a la vez. Cada tensión del H1 se traduce en un par de características que compiten, y los escenarios de la sección~8 fijan hasta dónde se puede ceder en cada una.
...
% ------------------------------------------------------------
\subsection{Cambios respecto al H1}

\begin{itemize}
  \item Cada característica se precisa con su subcaracterística de ISO/IEC~25010. Por ejemplo, QA-06 ya no es \emph{fiabilidad} en general, sino recuperabilidad, tolerancia a fallos y disponibilidad.
  \item QA-08 se reformula como responsabilidad (accountability). La parte de proceso, que cada semana haya un incremento demostrable (CRN-08, CON-14), se cubre con QA-05 y QA-07. La trazabilidad de decisiones (CRN-09) se cumple con la documentación y no con el producto.
  \item QA-09 pasa a tratarse como protección (safety): lo que importa es que el chat falle de forma segura cuando algo no funciona.
  \item Se agrega QA-10, instalabilidad, condicionada a Q-10, porque CRN-25 impone requisitos de empaquetado que el H1 no había cubierto.
  \item Se agrega la prioridad y la relación entre características mediante las tensiones.
\end{itemize}
