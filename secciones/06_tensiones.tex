% ============================================================
\section{Tensiones y conflictos (TEN)}\label{sec:tensiones}
% ============================================================
...
\endhead
Conflicto &
Simplicidad y privacidad (REQ-05 resuelto por conteo de reportes) frente a la corrección de la sanción. \\ \hline
Stakeholders &
...
\endhead
Conflicto &
REQ-03 (segundo factor obligatorio) frente a REQ-07 y CRN-01 (comprensible para 8 años). \\ \hline
Stakeholders &
...
Trade-off &
Aplicar el segundo factor de forma escalonada (solo en dispositivos nuevos o solo en cuentas con datos sensibles) y delegar la recuperación en el tutor. Se conserva el cumplimiento de REQ-03 y se paga con un modelo de cuentas más complejo y con estados de sesión adicionales. \\ \hline
\end{tabla}
