...
Guían la elección de la arquitectura. Una alternativa que no pueda cumplir alguno se descarta, aunque sea mejor en otros aspectos. Son los candidatos a requisitos arquitectónicamente significativos (sección~\ref{sec:asr}). \\ \hline
(M, A) & ESC-14 &
