% ============================================================
\section{Restricciones y requisitos impuestos (CON, REQ)}\label{sec:restricciones}
% ============================================================
...
% ------------------------------------------------------------
\subsection{Requisitos impuestos por el cliente}

Los siguientes elementos no son restricciones en sentido estricto: son requisitos funcionales y de calidad que el cliente fija de antemano, en lugar de decisiones sobre tecnología o proyecto. Se listan en esta sección, con el prefijo REQ para distinguirlos, porque comparten con las restricciones la propiedad que importa para el análisis: no son negociables y acotan las alternativas arquitectónicas antes de que exista un diseño.

\begin{tabla}{|L{1.1cm}|L{4.3cm}|L{2.75cm}|Y|}
\hline
\filacab \cab{ID} & \cab{Requisito} & \cab{Origen} & \cab{Cómo limita las alternativas arquitectónicas} \\ \hline
\endhead
REQ-01 & El juego debe contar con modo multijugador en línea. & Cliente (STK-03) &
...
REQ-02 & El tiempo de respuesta debe ser menor a 1 segundo. & Jugadores (STK-01) &
...
REQ-03 & Debe existir un segundo factor de autenticación. & Cliente y seguridad (STK-03, STK-15) &
...
REQ-04 & El chat debe contar con filtro de palabras. & Padres y legal (STK-02, STK-17) &
Al ser obligatorio y no evadible, debe ejecutarse del lado del servidor y no del cliente. \\ \hline
REQ-05 & Debe existir un mecanismo de moderación de conductas. & Cliente (STK-03) &
...
REQ-06 & El juego debe permitir cambiar de idioma. & Internacionalización (STK-03) &
Prohíbe cadenas incrustadas en el código y anchos fijos en la interfaz. Es transversal a todo el diseño. \\ \hline
REQ-07 & El juego debe ser comprensible para niños de 8 años o más. & Público objetivo (STK-01) &
