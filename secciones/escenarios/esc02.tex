...
\parte{Restricciones y dependencias}{REQ-07 (comprensible para niños de 8 años o más), REQ-06 (cambio de idioma).}
\parte{Tensiones y preguntas}{TEN-05 Interfaz para niños contra interfaz multilingüe.}
\parte{Tipo y prioridad}{De uso, en tiempo de ejecución. Prioridad (A, B).}
\bloque{Escenario}
