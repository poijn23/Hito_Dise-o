% ============================================================
\section{Dependencias externas (DEP)}\label{sec:dependencias}
% ============================================================
...
Existe con certeza porque REQ-03 lo impone, pero el proveedor concreto está sin decidir. Exige gestión de secretos y una ruta de recuperación de acceso. \\ \hline
...
DEP-04 & Infraestructura de servidores y red & Firme (REQ-01) &
El modo en línea es obligatorio, por lo que el sistema depende de un servidor disponible. La latencia y las caídas quedan fuera del control del equipo y afectan directamente el cumplimiento de REQ-02. \\ \hline
